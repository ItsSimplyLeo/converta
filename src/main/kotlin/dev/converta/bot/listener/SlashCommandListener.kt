...
class SlashCommandListener(private val convertaBot: ConvertaBot) : ListenerAdapter() {
    ...
    private fun handleAbout(event: SlashCommandInteractionEvent) {
        ...
        val embed = EmbedBuilder()
            ...
            .setDescription("Converta is a versatile unit conversion bot that supports various types of conversions including temperature, length, data, speed, volume, and weight.")
            ...
            .addField("Invite", "[Click here to invite me!](${convertaBot.botInviteLink})", true)
            .addField("Support Server", "[Join my support server!](${convertaBot.supportServerInviteLink})", true)
            .setFooter("Made using JDA and Kotlin - ${convertaBot.websiteUrl}")
            .setColor(0x00BFFF)
            .build()
    ...
    private fun handleInvite(event: SlashCommandInteractionEvent) {
        val embed = EmbedBuilder()
            ...
            .addField("Invite Link", "[Click here to invite](${convertaBot.botInviteLink})", false)
            .setColor(0x00BFFF)
            .build()
